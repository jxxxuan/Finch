...
def run_check(update_function, selected_rule, task_name, type, num_to_update=999999, num_worker=1, max_run_time_minutes=999999, **kwargs):
...
def manually_run_check(update_function, type, task_name, **kwargs):
    ...
    run_check(update_function, selected_rule, task_name, type, num_to_update, num_worker, max_run_time_minutes, **kwargs)